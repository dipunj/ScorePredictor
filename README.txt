...
2.	cost.m			Function		evaluate cost.
...
Software Requirements : 1. MATLAB R2015a or later
			2. CSV file reader (MS Excel, notepad etc)
			3. ASCII text reader
Hardware Requirements : None in Specific
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 * RUNNING THE PROGRAM
 ---------------------
	...
	4. After the program finishes to train the model. The command window shall print 'TRAINING FINISHED'.
